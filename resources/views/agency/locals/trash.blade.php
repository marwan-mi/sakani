...
@stop
@section('content')
<h2 style="color:rgb(216, 216, 216);margin-left:-25px">Trashed locals :</h2><br><br>
@if($locals->count()>0)
...
<div class="" >
      ...
      <div class="description" style="height:89%">
        ...
        <div style="display:flex;justify-content:center;margin-top:91px">
            <a class="btn-restore" href="{{route('local.restore',['id'=>$local->id])}}">restore</a>
            <a class="btn-delete" href="{{route('local.deletep',['id'=>$local->id])}}"  >Destroy</a>
        </div>
        <div >
...
@section('script')
    ...
    <script>
$(".l11").css("background-color", "#52B586");
    </script>
@stop